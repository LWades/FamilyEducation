...
<div style="width: 100%;height: 590px;background-color: #eeeeee">

    <div style="width: 1260px;height: 470px;background-image: url(/picture/Teacher/myApply.bmp);margin: auto;">

        <div style="height: 420px;width: 400px;margin: auto;background:rgba(255,255,255,0.4);position: relative;top: 20px;
     border-radius: 8px">
